...
namespace VayCayPlannerWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = CreateUser();
                // the user name is the same as the email
                ...
                if (result.Succeeded)
                {
                    ...
                    //adding the user to the default "User" role
        ...
        private Subscriber CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Subscriber)}'. " +
                    $"Ensure that '{nameof(Subscriber)}' is not an abstract class and has a parameterless constructor, or alternatively " +
